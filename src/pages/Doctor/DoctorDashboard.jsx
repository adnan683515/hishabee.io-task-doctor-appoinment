...
const DoctorDashboard = () => {
    ...
    return (
        <div className="p-4 md:p-8 ">
            ...
            {
                isOpen && <ActionModal editStatus={editstatus} refetch={refetch} ID={id} isOpen={isOpen} setIsOpen={setIsOpen} ></ActionModal>
            }
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className={`mt-2 px-3 py-1 rounded-md text-white text-[12px] ${isOpen ? "bg-indigo-600" : "bg-gray-400 hover:bg-indigo-500"
                                        }`}
                                >
                                    Action
                                </button>
